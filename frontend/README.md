...
> This is the Flutter app half of the repo — `../backend/` holds the Node
> API (see `../README.md` for the two-folder layout). Every command below
> assumes your shell is already inside this `frontend/` directory.
