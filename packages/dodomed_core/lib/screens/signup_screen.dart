...
/// Shared by both apps — see `login_screen.dart` for why [homeRoute]/
/// [isAllowed]/[deniedMessage] exist instead of a hardcoded destination.
  ...
  Future<void> _signup() async {
    ...
    try {
      ...
      if (widget.isAllowed != null && !widget.isAllowed!(state)) {
        ...
        _showError(widget.deniedMessage ?? "This account can't use this app.");
        return;
      }
