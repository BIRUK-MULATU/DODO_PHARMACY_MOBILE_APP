...
class DodomedAdminApp extends StatefulWidget {
  const DodomedAdminApp({super.key});

  @override
  State<DodomedAdminApp> createState() => _DodomedAdminAppState();
}

class _DodomedAdminAppState extends State<DodomedAdminApp> {
      ...
      child: AppStateScope(
        ...
        child: MaterialApp(
          ...
          builder: (context, child) {
            ...
            // On wide screens (web / tablet / a desk admin's monitor) frame
            // the app in a phone-width card so the layouts stay legible —
            // same convention as the user app.
            const w = 430.0;
            return ColoredBox(
